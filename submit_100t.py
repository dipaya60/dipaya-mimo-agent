...
CONFIG = {
    ...
    "project_description": "MiMo Crypto Intelligence Agent is an AI-powered crypto analysis platform built on Xiaomi MiMo-V2.5-Pro. The core feature is an advanced whale tracker with 10 modules: Smart Money Score (wallet profiling 0-100), Exchange Flow Analysis (CEX inflow/outflow), Whale vs Retail Divergence detection, Order Book Wall scanning, Cross-chain Tracking across 7 networks, VC Wallet Tracking (a16z, Paradigm, Coinbase Ventures), Historical Pattern Matching, customizable Alert Thresholds, Holder Concentration Index (Gini coefficient), and Activity Heatmap by hour/day. All modules include real-time Volume, Open Interest, Funding Rate, and Liquidation Levels. Market data uses CoinGecko API (free) for volume and price. The reasoning engine powered by MiMo-V2.5-Pro correlates whale behavior with derivatives data to generate actionable signals. Additional modules include sentiment analysis, Solidity smart contract auditing, and airdrop discovery across 9 EVM chains and Solana. I use this agent daily for whale tracking, contract audits, and airdrop research.",
    "github_link": "https://github.com/dipaya60/dipaya-mimo-agent",
    "screenshot_path": "/home/ubuntu/mimo-agent-advanced/assets/demo_full.png",
